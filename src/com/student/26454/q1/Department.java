...
public class Department extends Hospital {
    ...
    public Department(long id, String createdDate, String updatedDate, String hospitalName,
        ...
        if (!departmentCode.matches("^[A-Za-z0-9]+$")) {
            throw new HospitalDataException("Department code must be alphanumeric");
        }
